 ...
 */
export interface FlatGridProps<ItemType> extends FlatListProps<ItemType>, CommonProps<ItemType> {
  /**
...
const FlatGrid = forwardRef(<T,>(props: FlatGridProps<T>, ref: React.Ref<FlatList<T>>) => {
  const {
    style = {},
    spacing = 10,
    fixed = false,
